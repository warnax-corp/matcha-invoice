	...
	<div class="contents_box">
		...
		<div class="contents_area">
			...
			<table width="880" cellpadding="0" cellspacing="0" border="0">
				...
				<tr><td colspan="2" class="line"><?php echo $html->image('i_line_solid.gif'); ?></td></tr>
				<tr>
					<th style="width:150px;" <?php echo $form->error("ADDRESS")?' class="txt_top"':''; ?>>住所</th>
					<td style="width:730px;">
			...
			<table width="880" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td>
						...
						<br /><span class="must"><?php echo $form->error('SEAL_STR'); ?></span>
					</td>
				</tr>
			</table>
			</div>
			<table width="880" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<th>押印設定</th>
					<td><?php echo $form->radio('CHR_SEAL_FLG', $seal_flg, array('label' => false, 'legend' => false, 'class' => 'ml20 mr5 txt_mid')); ?>
