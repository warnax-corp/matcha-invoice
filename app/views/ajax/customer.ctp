...
<div id="popup_contents">
	<?php echo $html->image('/img/popup/tl_customer.jpg',array('style'=>'padding-bottom:10px;')); ?>
		...
		<div class="popup_contents_area clearfix">
			<table width="440" cellpadding="0" cellspacing="0" border="0">
				<tr class="popup_cname">
					<th style="width:130px;">社名<?php echo $html->image('i_must.jpg',array('alt'=>'必須','class'=>'pl10')); ?></th>
					<td style="width:310px;"><?php echo $form->text("NAME",array('class'=>'w300', 'maxlength' => 60)); ?></td>
				</tr>
				<tr><td colspan="2" class="line"><?php echo $html->image('/img/popup/i_line_solid.gif'); ?></td></tr>
				<tr class="popup_ckname">
					<th>社名（カナ）</th>
					<td><?php echo $form->text("NAME_KANA",array('class'=>'w300','maxlength' => 100)); ?></td>
				</tr>
				<tr><td colspan="2" class="line"><?php echo $html->image('/img/popup/i_line_solid.gif'); ?></td></tr>
			...
			<div class="save_btn">
				<?php echo $html->link($html->image('bt_save2.jpg'),'#',array('escape' => false,'onclick'=>'return popupclass.popupinsert(\'customer\')',null,false)); ?>
