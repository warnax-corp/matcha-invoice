...
$(document).ready(function($){
	...
	$('input[type="radio"]').click(function(){
		if($(this).val() == 0){
			$('div.ps_class').slideUp();
			$('input[name="data[Administer][EDIT_PASSWORD]"]').val("");
			$('input[name="data[Administer][EDIT_PASSWORD1]"]').val("");
		}
		if($(this).val() == 1){
			$('div.ps_class').slideDown();
		}
	});
});
...
//-->
			...
			<table width="880" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<td colspan="2">
						<?php echo $form->radio('CHANGEFLG', array(0 => 'パスワードを変更しない', 1 => 'パスワードを変更する'), array('label' => false, 'legend' => false, 'class' => 'ml20 mr5 txt_mid')); ?>
					</td>
				</tr>

				<tr><td colspan="2" class="line"><div class="ps_class"><?php echo $html->image('i_line_solid.gif'); ?></div></td></tr>
				<tr>
					<th style="width:170px; padding:0px;" <?php echo $form->error("EDIT_PASSWORD")?' class="txt_top"':''; ?>><div class="ps_class"><span class ="float_l">　パスワード</span></div></th>
					<td style="width:710px; padding:0px;"><div class="ps_class">
					<?php echo $form->password('EDIT_PASSWORD', array('class' => 'w300'.(($form->error('EDIT_PASSWORD') || $error['PASSWORD'])?' error':''),'maxlength'=>20)); ?>
					<br /><span class="usernavi"><?php echo $usernavi['USR_PASSWORD']; ?></span>
					<br /><span class="must"><?php echo $form->error('EDIT_PASSWORD'); if($error['PASSWORD'] == 1) echo "パスワードを入力してください"; ?></span></div>
					</td>
				</tr>

				<tr><td colspan="2" class="line"><div class="ps_class"><?php echo $html->image('i_line_solid.gif'); ?></td></tr>
				<tr>
					<th style="width:170px; padding:0px;" <?php echo $form->error("EDIT_PASSWORD1")?' class="txt_top"':''; ?>><div class="ps_class"><span class ="float_l">　パスワード(確認)</span></div></th>
					<td style="width:710px; padding:0px;"><div class="ps_class">
					...
					<br /><span class="must"><?php echo $form->error('EDIT_PASSWORD1'); ?></span></div>
					</td>
				</tr>
